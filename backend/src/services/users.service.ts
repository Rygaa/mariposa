...
async function update(
  data: Partial<Omit<SchemaDrizzle.User, 'createdAt'>> & { id: string },
  tx: DbTransactionOrDB = db
...
async function create(data: Omit<SchemaDrizzle.NewUser, 'id'>, tx: DbTransactionOrDB = db): Promise<SchemaDrizzle.User> {
