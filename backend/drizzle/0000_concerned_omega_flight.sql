CREATE TYPE "public"."E_EatingTableMenuItemStatus" AS ENUM('PENDING', 'STARTED', 'DONE', 'PRINTED', 'PAID', 'CONFIRMED');--> statement-breakpoint
CREATE TYPE "public"."E_EatingTableType" AS ENUM('TAKEAWAY', 'EMPLOYEES', 'WAST', 'GIFT');--> statement-breakpoint
CREATE TYPE "public"."E_ItemType" AS ENUM('MENU_ITEM', 'RECIPE', 'RAW_MATERIAL', 'SUPPLEMENT', 'MENU_ITEM_OPTION');--> statement-breakpoint
...
CREATE TABLE "MenuItemIngredient" (
	...
	"ingredientMenuItemId" varchar NOT NULL,
...
CREATE TABLE "MenuItemOrder" (
	...
	"price" real NOT NULL,
	"status" "E_EatingTableMenuItemStatus" DEFAULT 'PENDING' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "MenuItem" (
	"id" varchar PRIMARY KEY NOT NULL,
	"name" text NOT NULL,
	"itemType" "E_ItemType" DEFAULT 'MENU_ITEM' NOT NULL,
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL,
	"deletedAt" timestamp,
	"createdById" varchar,
