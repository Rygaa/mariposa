...
export const Item = (props: ItemProps) => {
  ...
  return props.shouldHide ? (
    ...
    <div className="relative flex w-full rounded-[25px] h-[175px] sm:h-[200px] shadow-lg bg-white border border-gray-200 py-2 px-3">
      {props.menuItem.image ? (
        <img
          src={`${import.meta.env.VITE_API_URL}${props.menuItem.image}`}
          alt={props.menuItem.name}
          className="box-border rounded-[25px] object-cover bg-[url('milkshake.jpg')] z-10 w-[120px] sm:w-[140px]"
          onError={(e) => {
      ...
      <div className="flex flex-col justify-between pr-2 sm:mt-3 w-full">
        <div>
          <p className="font-semibold self-start text-left text-black pt-1 sm:pt-2 px-2 sm:px-4 text-base lg:text-lg text-lg">
            {props.menuItem?.name}
          </p>
        ...
        <div className="flex justify-between items-center w-full">
          <p className="font-bold self-end px-2 sm:px-4 text-black text-base  lg:text-lg">
