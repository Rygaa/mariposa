<script lang="ts">
	...
	let { children, class: className = '', closeOnBackdrop = true }: Props = $props();
...
{#if dialog.isOpen()}
	...
	>
		...
		<div
			...
			class="relative w-full max-w-lg bg-white rounded-lg shadow-xl flex flex-col max-h-[90vh] overflow-auto {className}"
			tabindex="-1"
